...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-amr-014-0006-algebraic-stories-the-k-rank-of-monomi-ccc245f9",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-014-0006-9df4f08f2ac1",
        "url": "https://www.unsolvedmath.com/problems/AMR-014-0006"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Given $k \\geq 3$ and a monomial $x^a y^b$ of degree $a+b=kd$, it is known that $\\operatorname{rk}_k(x^{a}y^{b}) \\leq \\max(s,t)+1$, where $s$ and $t$ are the remainders of the division of $a$ and $b$ by $k$, see . Is it true that the latter inequality is, in fact, an equality?",
      "version": 1
    },
    "title": "Algebraic Stories — The $k$-rank of monomials",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "c69df964f9b8440ee15e952aa67acc66868fc3aca2805b9a9544574a5de2d315"
}
```
